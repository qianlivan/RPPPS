...
do
  ...
  then
    ...
    echo "cp "$RPPPS_DIR"/qsub_template.bash ./"$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".qsub" >> $cutting_script
    #set task name
    echo "echo #PBS -N "$file1_noext"_search >> "$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".qsub" >> $cutting_script
    ...
    #pulsar search
    echo "echo bash "$RPPPS_DIR"/RPPPS_start.presto "$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".fits "$threads_num" "$accel_zmax" "$para_version" >> "$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".qsub" >> $cutting_script
    #show the date
    echo "echo date >> "$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".qsub" >> $cutting_script
    #submit the task
    echo "echo Submitting the task" >> $cutting_script
    echo "qsub -q low -d "$current_data_path"/beams_"$band_selection" "$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".qsub >> /dev/null" >> $cutting_script
    echo "cd .." >> $cutting_script
  fi
  if((flag_cut==1))
  then
    ...
    #submit search job
    echo "cd ./"$beam_folder"/" >> $cutting_script
    echo "cp "$RPPPS_DIR"/qsub_template.bash ./"$file1_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file1_end".qsub" >> $cutting_script
    #set task name
    echo "echo #PBS -N "$file1_noext"_start >> "$file1_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file1_end".qsub" >> $cutting_script
    #change to current path
    #echo "echo cd "$current_data_path"/beams_"$band_selection" >> "$file1_noext"_"$file2_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file2_end".qsub" >> $cutting_script
    #pulsar search
    echo "echo bash "$RPPPS_DIR"/RPPPS_search.presto "$file1_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file1_end".fits "$threads_num" "$accel_zmax" "$para_version" >> "$file1_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file1_end".qsub" >> $cutting_script
    #show the date
    echo "echo date >> "$file1_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file1_end".qsub" >> $cutting_script
    #submit the task
    echo "echo Submitting the task" >> $cutting_script
    echo "qsub -q low -d "$current_data_path"/beams_"$band_selection" "$file1_noext"_tot_"$channel_start"_"$channel_end"_"$subints_file1_start"_"$subints_file1_end".qsub >> /dev/null" >> $cutting_script
    echo "cd .." >> $cutting_script
  fi
